	...
	*/
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<h3 class="text-left">
				<?php
				echo "<a href=\"index.html\">Inicio</a> - Consultar noticias";
				?>
			</h3>
			<br>
			<?php			
				...
				while($reg=mysqli_fetch_array($rs)){					
					...
					echo "<br>";
					echo "<span class=\"texto\"><img src=\"../img/noticias/$foto_noticia\"></span>";
					echo "<br>";
					echo "<br>";
					echo "<span class=\"texto\">Titulo articulo: </span>".$nombre_noticia;
					echo "<br>";
					echo "<br>";
					echo "<span class=\"texto\">Contenido articulo: </span>".$contenido;
					echo "<br>";					
				...
				if ($total_paginas > 1){ 
					for ($i=1;$i<=$total_paginas;$i++){ 
						if ($pagina == $i) 
							...
							echo "<a href='consultar-noticias.php?pagina=" . $i . "' class=\"textSize\">"  . $i .  "</a> " ; 
					}   
				}
