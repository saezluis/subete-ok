		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-10">
					<h3 class="text-left">
					<?php
						echo "<a href=\"index.html\">Inicio</a> - <a href=\"optimismo-home.php\">Pilar: Optimismo</a> - Modificar contenido";
					?>						
					</h3>
					<br>					
						<?php
						while($reg=mysqli_fetch_array($registrosOptimismo)){
							...
							echo "<li>Titulo contenido: <a href=\"edit-optimismo.php?id_send=",urlencode($id_opti)," \">$titulo_opti</a> </li>";
							echo "<br>";
