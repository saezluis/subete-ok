		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-10">
					...
					<br>
					<form method="post" action="delete-superacion.php">					
						<?php	
						
						echo "<li>Titulo contenido: <input type=\"text\" size=\"55\" value=\"$titulo_superacion\" readonly></li>";	
						
						echo "<input type=\"text\" name=\"id-superacion-send\" value=\"$id_superacion\" hidden=hidden>";
						
						?>
						<br>
						<?php echo "<li>Contenido: <textarea rows=\"10\" cols=\"80\" readonly>$contenido_superacion</textarea></li>";	?>
						<br>						
						<button type="submit" onClick="alert('El contenido fue eliminado')">Eliminar</button>  &nbsp; &nbsp;  <button type="button"><a href="superacion-home.php">Cancelar</a></button>
					</form>					
				</div>
			</div>
		</div>
