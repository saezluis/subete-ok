		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-10">
					...
					<br>
					<form method="post" action="delete-profesionalismo.php">					
						<?php	
						
						echo "<li>Titulo contenido: <input type=\"text\" size=\"55\" value=\"$titulo_profe\" readonly></li>";	
						
						echo "<input type=\"text\" name=\"id-profesionalismo-send\" value=\"$id_profe\" hidden=hidden>";
						
						?>
						<br>
						<?php echo "<li>Contenido: <textarea rows=\"10\" cols=\"80\" readonly>$contenido_profe</textarea></li>";	?>
						<br>						
						<button type="submit" onClick="alert('El contenido fue eliminado')">Eliminar</button>  &nbsp; &nbsp;  <button type="button"><a href="profesionalismo-home.php">Cancelar</a></button>
					</form>					
				</div>
			</div>
		</div>
