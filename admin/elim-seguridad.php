		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-10">
					...
					<br>
					<form method="post" action="delete-seguridad.php">					
						<?php	
						
						echo "<li>Titulo contenido: <input type=\"text\" size=\"55\" value=\"$titulo_seguridad\" readonly></li>";	
						
						echo "<input type=\"text\" name=\"id-seguridad-send\" value=\"$id_seguridad\" hidden=hidden>";
						
						?>
						<br>
						<?php echo "<li>Contenido: <textarea rows=\"10\" cols=\"80\" readonly>$contenido_seguridad</textarea></li>";	?>
						<br>						
						<button type="submit" onClick="alert('El contenido fue eliminado')">Eliminar</button>  &nbsp; &nbsp;  <button type="button"><a href="seguridad-home.php">Cancelar</a></button>
					</form>					
				</div>
			</div>
		</div>
