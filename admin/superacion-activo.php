		...
		<div class="row">
			...
			<?php			
				...
				while($reg=mysqli_fetch_array($rs)){
					...
					$sendThis = $estatus.$id_superacion;
					...
					echo "<br>";					
					echo "<span class=\"texto\" onclick=\"mensaje();\"><a href=\"superacion-establecer-activo.php?estatus=",urlencode($sendThis)," \">Establecer como articulo activo</a></span>";
					echo "<br>";					
				...
				if ($total_paginas > 1){ 
					for ($i=1;$i<=$total_paginas;$i++){ 
						if ($pagina == $i) 
							...
							echo "<a href='superacion-activo.php?pagina=" . $i . "' class=\"textSize\">"  . $i .  "</a> " ; 
					}   
				}
