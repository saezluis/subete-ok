		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-10">
					<h3 class="text-left">
						<?php
							echo "<a href=\"index.html\">Inicio</a> - <a href=\"editar-usuario.php\">Editar usuario</a> - ".$_SESSION["type_user"]." ";
						?>
					</h3>
					<br>
					<form method="post" action="update-usuario.php">
						...
						<br>
						<li>Nombre: <?php echo "<input type=\"text\" name=\"nombre-send\" value=\"$nombre\">"; ?></li>
						<br>
						<li>Apellido Paterno: <?php echo "<input type=\"text\" name=\"apellido-paterno-send\" value=\"$apellido_paterno\">"; ?></li>
						<br>
						<li>Apellido Materno: <?php echo "<input type=\"text\" name=\"apellido-materno-send\" value=\"$apellido_materno\">"; ?></li>
						<br>
						<li>Sexo: <select name="sexo-send">
									 <?php
										$mas = '';
										$fem = '';
										if($sexo=='masculino'){
						...
						<br>
						<li>Fecha nacimiento: <?php echo "<input type=\"text\" name=\"fecha-nacimiento-send\" value=\"$fecha_nacimiento\">"; ?></li>
						<br>						
						<li>Password: <?php echo "<input type=\"text\" name=\"password-send\" value=\"$password\">"; ?></li>
						<br>
						<li>Telefono/Movil: <?php echo "<input type=\"text\" name=\"telefono-send\" value=\"$telefono\">"; ?></li>
						<br>
						<li>Comuna residencia: <select name="comuna-send">
									<?php
						...
						<br>
						<li>Correo electronico: <?php echo "<input type=\"text\" name=\"email-send\" value=\"$email\">"; ?></li>
						<br>		
						<li>Temas de interes: <?php echo "<textarea name=\"temas-interes-send\">$temas_interes</textarea>"; ?></li>
						<br>
						<button type="submit" onClick="alert('Sus datos fueron actualizados')">Actualizar datos</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <button type="button"><a href="editar-usuario.php">Cancelar</a></button>
					</form>
