		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-10">
					<h3 class="text-left">
					<?php
						echo "<a href=\"index.html\">Inicio</a> - <a href=\"superacion-home.php\">Pilar: Superacion</a> - Modificar contenido";
					?>						
					</h3>
					<br>					
						<?php
						while($reg=mysqli_fetch_array($registrosSuperacion)){
							...
							echo "<li>Titulo contenido: <a href=\"edit-superacion.php?id_send=",urlencode($id_superacion)," \">$titulo_superacion</a> </li>";
							echo "<br>";
