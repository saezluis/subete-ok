		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-10">
					<h3 class="text-left">
					<?php
						echo "<a href=\"index.html\">Inicio</a> - <a href=\"profesionalismo-home.php\">Pilar: Profesionalismo</a> - Modificar contenido";
					?>						
					</h3>
					<br>					
						<?php
						while($reg=mysqli_fetch_array($registrosProfesionalismo)){
							...
							echo "<li>Titulo contenido: <a href=\"edit-profesionalismo.php?id_send=",urlencode($id_profe)," \">$titulo_profe</a> </li>";
							echo "<br>";
