		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-10">
					<h3 class="text-left">
					<?php
						echo "<a href=\"index.html\">Inicio</a> - <a href=\"responsabilidad-home.php\">Pilar: Responsabilidad</a> - Eliminar contenido";
					?>						
					</h3>
					<br>					
						<?php
						while($reg=mysqli_fetch_array($registrosResponsabilidad)){
							...
							echo "<li>Titulo contenido: <a href=\"elim-responsabilidad.php?id_send=",urlencode($id_respo)," \">$titulo_respo</a> </li>";
							echo "<br>";
