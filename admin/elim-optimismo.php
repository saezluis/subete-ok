		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-10">
					...
					<br>
					<form method="post" action="delete-optimismo.php">					
						<?php	
						
						echo "<li>Titulo contenido: <input type=\"text\" size=\"55\" value=\"$titulo_opti\" readonly></li>";	
						
						echo "<input type=\"text\" name=\"id-optimismo-send\" value=\"$id_opti\" hidden=hidden>";
						
						?>
						<br>
						<?php echo "<li>Contenido: <textarea rows=\"10\" cols=\"80\" readonly>$contenido_opti</textarea></li>";	?>
						<br>						
						<button type="submit" onClick="alert('El contenido fue eliminado')">Eliminar</button>  &nbsp; &nbsp;  <button type="button"><a href="optimismo-home.php">Cancelar</a></button>
					</form>					
				</div>
			</div>
		</div>
