		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-10">
					<h3 class="text-left">
					<?php
						echo "<a href=\"index.html\">Inicio</a> - <a href=\"productividad-home.php\">Pilar: Productividad</a> - Modificar contenido";
					?>						
					</h3>
					<br>					
						<?php
						while($reg=mysqli_fetch_array($registrosProductividad)){
							...
							echo "<li>Titulo contenido: <a href=\"edit-productividad.php?id_send=",urlencode($id_produ)," \">$titulo_produ</a> </li>";
							echo "<br>";
